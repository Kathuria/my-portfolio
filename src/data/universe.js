...
export const NODES = [
  ...
  },
  {
    ...
    r: 30,
    title: 'Elsewhere',
    tagline: 'Writing and shorter thoughts, off the main site',
    description:
      "None of these have much to show as a live preview on their own — a Facebook page, a Quora profile, a Medium account, and an X handle mostly refuse to be embedded or don't have much to render outside their own apps. Grouped together here rather than as four thin, mostly-empty stars.",
    profiles: [
      {
        id: 'astonishing-facts',
        label: 'Astonishing Facts',
        platform: 'Facebook',
        tagline: 'A separate community for the surprising and remarkable',
        url: 'https://www.facebook.com/AstonishingFactsYouReallyNeedToKnow',
      ...
      },
      {
        ...
        label: 'Medium',
        platform: 'Medium',
        tagline: 'Long-form technical and personal writing',
        url: 'https://medium.com/@avikathuria21',
      },
      {
        id: 'quora',
        label: 'Quora',
        platform: 'Quora',
        tagline: 'Answers and perspectives, more conversational than the blog',
        url: 'https://www.quora.com/profile/Avi-Kathuria',
      },
      {
        id: 'twitter',
        label: 'X',
        platform: '@kathuria_avi',
        tagline: 'Shorter, more casual updates',
        url: 'https://x.com/kathuria_avi',
      },
    ],
    noPreview: true,
  },
...
export const YOUTUBE_PLAYLISTS = [
  ...
  ['Chandigarh', 'PLE0T6MvWABcweo_ABxTIT79_ILj437z-W', '7ClZb1oKFcs'],
  ...
  ['World of Coca Cola', 'PLE0T6MvWABcyH5e0Tc0hyewGwlm2OnFyh', 'LrP6Bzub-lY'],
  ...
  ['Chicago Fed Museum', 'PLE0T6MvWABcwDg2xbrFf9GtbbaUd7MfnN', 'xSmYG6QlV5Q'],
  ...
  ['San Diego', 'PLE0T6MvWABczGavA1Fjh48H3A66KKvIGI', 'g1VJQZgRfuM'],
  ['San Diego Zoo', 'PLE0T6MvWABcwJ24RWUnhbEP2wBv6WXwEX', 'DsR1fe_Rx0U'],
];
